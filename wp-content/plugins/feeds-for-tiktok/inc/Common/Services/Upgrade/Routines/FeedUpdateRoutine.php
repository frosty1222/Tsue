...
class FeedUpdateRoutine extends ServiceProvider
{
	...
	public function register()
	{
		...
		add_action('sbtt_resize_post_images', array( $this, 'resize_post_images'), 10, 3);
	}
	 ...
	 * @param array $feed_settings The settings specific to the feed.
	 * @param int   $feed_id The ID of the feed.
	 * @return void
	 */
	public function resize_post_images($posts, $feed_settings, $feed_id)
	{
